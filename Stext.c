...
#define PORT 9091    // Port number for Stext server
...
void handle_client(int client_socket)
{
    ...
    while ((n = read(client_socket, buffer, BUFSIZE)) > 0)
    {
        ...
        write(client_socket, "Text file stored in Stext\n", 26);
    }
...
int main(int argc, char *argv[])
{
    ...
    // If port number is passed as an argument, use it; otherwise, use default PORT 9091
    ...
    server_addr.sin_port = htons(port);       // Set the port number for Stext
